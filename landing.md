...
/* Optional: Remove margin for small screens */
 ...
 /* Styling for the independent image */
    .independent-image {
        ...
        max-height: 10vh; /* Set a maximum height relative to the viewport */
 ...
 /* Media query for smaller screens */
    @media (max-width: 400px) {
        .independent-image {
            max-height: 10vh; /* Adjust maximum height for smaller screens */
            max-width: 10%; /* Adjust maximum width for smaller screens */
        }
    }
